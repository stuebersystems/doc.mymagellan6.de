[![Build status](https://ci.appveyor.com/api/projects/status/3xqinve2g690s8a9?svg=true)](https://ci.appveyor.com/project/stueber/doc-mymagellan6-de)

# MyMAGELLAN 6 Dokumentation
...
1. Erstelle einen lokalen Ordner für die Dokumentation, z.B. `c:\docs\mymagellan`.

2. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\mymagellan`.

3. Tippe den Befehl `git clone https://github.com/stuebersystems/doc.mymagellan6.de.git` ein, um das Repository zu klonen.
...
1. Öffne die URL `https://github.com/stuebersystems/doc.mymagellan6.de` in deinem Webbrowser

2. Klicke auf die Schaltfläche `Clone or download` und dann auf `Download ZIP`.

3. Entpacke das Zip-Archiv in einen lokalen Ordner Deiner Wahl, z.B. `c:\docs\mymagellan`.
